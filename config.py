...
token: str = tsukanoff.Telegram.token  # замените на Ваш Telegram-токен, например, token: str = 'AAААААААААААААААААААААА'
...
class AuthorInfo:
    ...
    author_phone: str = '+7XXXXXXXXXX'  # tsukanoff.phone_number -- номер телефона для поддержки
